...
Project one DPD plus Director Performance Intent, exact SpokenContent, stable Character Voice Profile and timing into the existing AudioPerformanceBrief. Specify recipient, spatial reach, pace/rhythm, intensity, breath support, phrase attack, articulation, emphasis, pause function, closure, coloration, release, continuity and DO NOT. High pressure can shorten or tighten delivery without crying. Close speech need not whisper. Never replace speaker identity because the actor is tired or has cried.
