---
name: set-decoration
description: Resolve the deprecated set-decoration design view through Specialized Asset Design; inspect retained originals without independently authoring concrete assets.
---

# set-decoration: compatibility view
