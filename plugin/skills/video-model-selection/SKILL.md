...
The currently inspected image preparation adapter supports three references. This is an execution capability, not a creative reference budget; return infeasibility when required duties cannot all be bound. Legacy Comfy video keeps its inspected modes; official video may consume the unified multimodal bundle after capability and continuity gates. Extra slots do not expand project authorization.
