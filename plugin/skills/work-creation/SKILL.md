...
Execute the selected plan as a complete candidate formal Work state. Preserve historical actors, sequence, outcomes, and material causality. A peripheral or invented viewpoint may carry the film, but must never take over a `PRIMARY` actor's attested decision or causal role. Political, military, social, and historical stakes may be concrete; personal stakes may be evidence-based or clearly labeled dramatic invention. `internalNeed` and private relationship arcs are optional Work choices and may drive invented interpersonal events; they must not falsify the attested historical causal chain or require every character to grow. Theme must emerge from the Historical Spine rather than cause new decisions. The result must independently tell Script adaptation what the story is, why it moves, how it culminates, what each architecture node maps to, and what must not drift. It must not be a few-line event summary, chronology dump, character list, placeholder, test content, scratchpad, Scene dialogue, or Shot detail. Do not persist a partial draft.
...
Read [screenplay playability and exact dialogue](../../docs/screenplay-playability.md). Retain literary meaning and source boundaries; do not turn Work into acting instructions. Route missing observable carriers to Screenplay.
