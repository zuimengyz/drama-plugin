...
def department_values(bible: SpecializedAssetBible, asset_id: str, department: str) -> dict[str, Any]:
    ...
    values = {fields[key]: decision.text for key, decision in asset.decisions.items() if key in fields}
    if not values:
