...
EXPECTED = {"cinematic-screenplay-incubation", "historical-research", "work-creation", "script-adaptation", "episode-development", "scene-development", "dramatic-performance-direction", "shot-design", "asset-resolution", "shot-production", "audio-production"}
CREATIVE = {
